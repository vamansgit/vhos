...
export default function Login() {
  ...
  const [email, setEmail] = useState("demo@adsaarthi.app");
    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-ink-900">Sign in to AdSaarthi</h1>
          <p className="mt-1 text-sm text-ink-500">Ad performance, creators, and content — one place.</p>
        </div>
