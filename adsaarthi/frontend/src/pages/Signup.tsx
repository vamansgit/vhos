    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-semibold text-ink-900">Create your brand workspace</h1>
          <p className="mt-1 text-sm text-ink-500">Free to start — connect your ad accounts in minutes.</p>
        </div>
